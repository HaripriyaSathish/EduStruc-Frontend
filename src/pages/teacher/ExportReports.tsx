      ...
      <div style={{ marginLeft: '240px', flex: 1, display: 'flex', flexDirection: 'column' }}>
        <header style={{ background: '#F8F9FF', borderBottom: '1px solid #E5E7EB', height: 'auto', minHeight: '80px', padding: '16px 28px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', position: 'sticky', top: 0, zIndex: 30 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            ...
            <span style={{ fontSize: '13px', color: '#0051D5', fontWeight: 500 }}>Export Reports</span>
          </div>
        ...
        <main style={{ padding: '28px 32px', flex: 1 }}>
          ...
          <div style={{ marginBottom: '24px' }}>
            <h1 style={{ fontFamily: 'Poppins, sans-serif', fontWeight: 700, fontSize: '22px', color: '#0B1C30', margin: '0 0 4px' }}>Export Reports</h1>
            <p style={{ fontSize: '13px', color: '#76777D', margin: 0 }}>Download real data reports from your classes and students.</p>
          </div>
