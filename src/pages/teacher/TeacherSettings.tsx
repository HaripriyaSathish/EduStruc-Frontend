...
export default function TeacherSettings() {
  ...
  try {
    ...
    if (res.ok) {
      ...
      alert('Photo upload failed to save. Please try again.');
    }
  } catch {
    alert('Cannot connect to server — photo was not saved. Please check your connection.');
  }
};
  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh', background: theme.pageBg, fontFamily: 'Inter, sans-serif', transition: 'background 0.2s ease' }}>
      ...
      <div style={{ marginLeft: '240px', flex: 1, display: 'flex', flexDirection: 'column' }}>
        ...
        <footer style={{ background: darkMode ? '#0F1830' : '#D3E4FE', borderTop: `1px solid ${theme.border}`, padding: '20px 48px', textAlign: 'center', transition: 'background 0.2s ease' }}>
